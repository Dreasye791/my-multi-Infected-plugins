...
public OnPluginStart()
{
    ...
    new Handle:hCvarEnabled = CreateConVar("sm_aidmgfix_enable", "2", "Bit flag: Enables plugin features (add together): 1=Skeet pouncing AI, 2=Debuff charging AI, 4=Block stumble scratches, 7=all, 0=off", FCVAR_SPONLY);
